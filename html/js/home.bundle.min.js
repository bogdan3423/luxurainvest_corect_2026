...
!function(a,b){if("function"==typeof define&&define.amd)define(["module","exports"],b);else if("undefined"!=typeof exports)b(module,exports);else{var c={exports:{}};b(c,c.exports),a.WOW=c.exports}}(this,function(a,b){"use strict";function c(a,b){if(!(a instanceof b))throw new TypeError("Cannot call a class as a function")}function d(a,b){return b.indexOf(a)>=0}function e(a,b){for(var c in b)if(null==a[c]){var d=b[c];a[c]=d}return a}function f(a){return/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(a)}function g(a){var b=arguments.length<=1||void 0===arguments[1]?!1:arguments[1],c=arguments.length<=2||void 0===arguments[2]?!1:arguments[2],d=arguments.length<=3||void 0===arguments[3]?null:arguments[3],e=void 0;return null!=document.createEvent?(e=document.createEvent("CustomEvent"),e.initCustomEvent(a,b,c,d)):null!=document.createEventObject?(e=document.createEventObject(),e.eventType=a):e.eventName=a,e}function h(a,b){null!=a.dispatchEvent?a.dispatchEvent(b):b in(null!=a)?a[b]():"on"+b in(null!=a)&&a["on"+b]()}function i(a,b,c){null!=a.addEventListener?a.addEventListener(b,c,!1):null!=a.attachEvent?a.attachEvent("on"+b,c):a[b]=c}function j(a,b,c){null!=a.removeEventListener?a.removeEventListener(b,c,!1):null!=a.detachEvent?a.detachEvent("on"+b,c):delete a[b]}function k(){return"innerHeight"in window?window.innerHeight:document.documentElement.clientHeight}Object.defineProperty(b,"__esModule",{value:!0});var l,m,n=function(){function a(a,b){for(var c=0;c<b.length;c++){var d=b[c];d.enumerable=d.enumerable||!1,d.configurable=!0,"value"in d&&(d.writable=!0),Object.defineProperty(a,d.key,d)}}return function(b,c,d){return c&&a(b.prototype,c),d&&a(b,d),b}}(),o=window.WeakMap||window.MozWeakMap||function(){function a(){c(this,a),this.keys=[],this.values=[]}return n(a,[{key:"get",value:function(a){for(var b=0;b<this.keys.length;b++){var c=this.keys[b];if(c===a)return this.values[b]}}},{key:"set",value:function(a,b){for(var c=0;c<this.keys.length;c++){var d=this.keys[c];if(d===a)return this.values[c]=b,this}return this.keys.push(a),this.values.push(b),this}}]),a}(),p=window.MutationObserver||window.WebkitMutationObserver||window.MozMutationObserver||(m=l=function(){function a(){c(this,a),"undefined"!=typeof console&&null!==console&&(console.warn("MutationObserver is not supported by your browser."),console.warn("WOW.js cannot detect dom mutations, please call .sync() after loading new content."))}return n(a,[{key:"observe",value:function(){}}]),a}(),l.notSupported=!0,m),q=window.getComputedStyle||function(a){var b=/(\-([a-z]){1})/g;return{getPropertyValue:function(c){"float"===c&&(c="styleFloat"),b.test(c)&&c.replace(b,function(a,b){return b.toUpperCase()});var d=a.currentStyle;return(null!=d?d[c]:void 0)||null}}},r=function(){function a(){var b=arguments.length<=0||void 0===arguments[0]?{}:arguments[0];c(this,a),this.defaults={boxClass:"wow",animateClass:"animated",offset:0,mobile:!0,live:!0,callback:null,scrollContainer:null,resetAnimation:!0},this.animate=function(){return"requestAnimationFrame"in window?function(a){return window.requestAnimationFrame(a)}:function(a){return a()}}(),this.vendors=["moz","webkit"],this.start=this.start.bind(this),this.resetAnimation=this.resetAnimation.bind(this),this.scrollHandler=this.scrollHandler.bind(this),this.scrollCallback=this.scrollCallback.bind(this),this.scrolled=!0,this.config=e(b,this.defaults),null!=b.scrollContainer&&(this.config.scrollContainer=document.querySelector(b.scrollContainer)),this.animationNameCache=new o,this.wowEvent=g(this.config.boxClass)}return n(a,[{key:"init",value:function(){this.element=window.document.documentElement,d(document.readyState,["interactive","complete"])?this.start():i(document,"DOMContentLoaded",this.start),this.finished=[]}},{key:"start",value:function(){var a=this;if(this.stopped=!1,this.boxes=[].slice.call(this.element.querySelectorAll("."+this.config.boxClass)),this.all=this.boxes.slice(0),this.boxes.length)if(this.disabled())this.resetStyle();else for(var b=0;b<this.boxes.length;b++){var c=this.boxes[b];this.applyStyle(c,!0)}if(this.disabled()||(i(this.config.scrollContainer||window,"scroll",this.scrollHandler),i(window,"resize",this.scrollHandler),this.interval=setInterval(this.scrollCallback,50)),this.config.live){var d=new p(function(b){for(var c=0;c<b.length;c++)for(var d=b[c],e=0;e<d.addedNodes.length;e++){var f=d.addedNodes[e];a.doSync(f)}});d.observe(document.body,{childList:!0,subtree:!0})}}},{key:"stop",value:function(){this.stopped=!0,j(this.config.scrollContainer||window,"scroll",this.scrollHandler),j(window,"resize",this.scrollHandler),null!=this.interval&&clearInterval(this.interval)}},{key:"sync",value:function(){p.notSupported&&this.doSync(this.element)}},{key:"doSync",value:function(a){if("undefined"!=typeof a&&null!==a||(a=this.element),1===a.nodeType){a=a.parentNode||a;for(var b=a.querySelectorAll("."+this.config.boxClass),c=0;c<b.length;c++){var e=b[c];d(e,this.all)||(this.boxes.push(e),this.all.push(e),this.stopped||this.disabled()?this.resetStyle():this.applyStyle(e,!0),this.scrolled=!0)}}}},{key:"show",value:function(a){return this.applyStyle(a),a.className=a.className+" "+this.config.animateClass,null!=this.config.callback&&this.config.callback(a),h(a,this.wowEvent),this.config.resetAnimation&&(i(a,"animationend",this.resetAnimation),i(a,"oanimationend",this.resetAnimation),i(a,"webkitAnimationEnd",this.resetAnimation),i(a,"MSAnimationEnd",this.resetAnimation)),a}},{key:"applyStyle",value:function(a,b){var c=this,d=a.getAttribute("data-wow-duration"),e=a.getAttribute("data-wow-delay"),f=a.getAttribute("data-wow-iteration");return this.animate(function(){return c.customStyle(a,b,d,e,f)})}},{key:"resetStyle",value:function(){for(var a=0;a<this.boxes.length;a++){var b=this.boxes[a];b.style.visibility="visible"}}},{key:"resetAnimation",value:function(a){if(a.type.toLowerCase().indexOf("animationend")>=0){var b=a.target||a.srcElement;b.className=b.className.replace(this.config.animateClass,"").trim()}}},{key:"customStyle",value:function(a,b,c,d,e){return b&&this.cacheAnimationName(a),a.style.visibility=b?"hidden":"visible",c&&this.vendorSet(a.style,{animationDuration:c}),d&&this.vendorSet(a.style,{animationDelay:d}),e&&this.vendorSet(a.style,{animationIterationCount:e}),this.vendorSet(a.style,{animationName:b?"none":this.cachedAnimationName(a)}),a}},{key:"vendorSet",value:function(a,b){for(var c in b)if(b.hasOwnProperty(c)){var d=b[c];a[""+c]=d;for(var e=0;e<this.vendors.length;e++){var f=this.vendors[e];a[""+f+c.charAt(0).toUpperCase()+c.substr(1)]=d}}}},{key:"vendorCSS",value:function(a,b){for(var c=q(a),d=c.getPropertyCSSValue(b),e=0;e<this.vendors.length;e++){var f=this.vendors[e];d=d||c.getPropertyCSSValue("-"+f+"-"+b)}return d}},{key:"animationName",value:function(a){var b=void 0;try{b=this.vendorCSS(a,"animation-name").cssText}catch(c){b=q(a).getPropertyValue("animation-name")}return"none"===b?"":b}},{key:"cacheAnimationName",value:function(a){return this.animationNameCache.set(a,this.animationName(a))}},{key:"cachedAnimationName",value:function(a){return this.animationNameCache.get(a)}},{key:"scrollHandler",value:function(){this.scrolled=!0}},{key:"scrollCallback",value:function(){if(this.scrolled){this.scrolled=!1;for(var a=[],b=0;b<this.boxes.length;b++){var c=this.boxes[b];if(c){if(this.isVisible(c)){this.show(c);continue}a.push(c)}}this.boxes=a,this.boxes.length||this.config.live||this.stop()}}},{key:"offsetTop",value:function(a){for(;void 0===a.offsetTop;)a=a.parentNode;for(var b=a.offsetTop;a.offsetParent;)a=a.offsetParent,b+=a.offsetTop;return b}},{key:"isVisible",value:function(a){var b=a.getAttribute("data-wow-offset")||this.config.offset,c=this.config.scrollContainer&&this.config.scrollContainer.scrollTop||window.pageYOffset,d=c+Math.min(this.element.clientHeight,k())-b,e=this.offsetTop(a),f=e+a.clientHeight;return d>=e&&f>=c}},{key:"disabled",value:function(){return!this.config.mobile&&f(navigator.userAgent)}}]),a}();b["default"]=r,a.exports=b["default"]});(function($){"use strict";var $window=$(window);var $body=$("body");var preloaderHidden=false;function hidePreloader(){if(preloaderHidden){return}preloaderHidden=true;$(".preloader").stop(true,true).fadeOut(120)}$window.on("load",hidePreloader);setTimeout(hidePreloader,250);if($(".active-sticky-header").length){$window.on("resize",function(){setHeaderHeight()});function setHeaderHeight(){$("header.active-sticky-header").css("height",$("header.active-sticky-header .header-sticky").outerHeight())}function updateStickyHeader(){var fromTop=$window.scrollTop();setHeaderHeight();$("header.active-sticky-header .header-sticky").toggleClass("active",fromTop>20)}$window.on("scroll",updateStickyHeader);$window.on("load",updateStickyHeader);updateStickyHeader()}$("#menu").slicknav({label:"",prependTo:".responsive-menu"});if($("a[href='#top']").length){$(document).on("click","a[href='#top']",function(){$("html, body").animate({scrollTop:0},"slow");return false})}if($(".testimonial-slider").length){const testimonial_slider=new Swiper(".testimonial-slider .swiper",{slidesPerView:1,speed:1500,spaceBetween:30,loop:true,autoplay:{delay:5e3},pagination:{el:".testimonial-pagination",clickable:true},breakpoints:{768:{slidesPerView:2},1024:{slidesPerView:2},1440:{slidesPerView:3}}})}if($(".testimonial-slider-prime").length){const testimonial_slider_prime=new Swiper(".testimonial-slider-prime .swiper",{slidesPerView:1,speed:1e3,spaceBetween:30,loop:true,autoplay:{delay:5e3},pagination:{el:".testimonial-pagination-prime",clickable:true},breakpoints:{768:{slidesPerView:2},1440:{slidesPerView:3}}})}if($(".testimonial-slider-metal").length){const testimonial_slider_metal=new Swiper(".testimonial-slider-metal .swiper",{slidesPerView:1,speed:1500,spaceBetween:50,loop:true,autoplay:{delay:5e3},navigation:{nextEl:".testimonial-button-next-metal",prevEl:".testimonial-button-prev-metal"},breakpoints:{768:{slidesPerView:1}}})}if($(".company-supports-slider").length){const company_supports_slider=new Swiper(".company-supports-slider .swiper",{slidesPerView:2,speed:2e3,spaceBetween:30,loop:true,autoplay:{delay:5e3},breakpoints:{767:{slidesPerView:3},1024:{slidesPerView:4},1440:{slidesPerView:5}}})}if($(".company-supports-slider-prime").length){const company_supports_slider_prime=new Swiper(".company-supports-slider-prime .swiper",{slidesPerView:2,speed:2e3,spaceBetween:30,loop:true,autoplay:{delay:5e3},breakpoints:{767:{slidesPerView:3},1024:{slidesPerView:4},1440:{slidesPerView:5}}})}if($(".company-supports-slider-metal").length){const company_supports_slider_metal=new Swiper(".company-supports-slider-metal .swiper",{slidesPerView:2,speed:2e3,spaceBetween:30,loop:true,autoplay:{delay:5e3},breakpoints:{767:{slidesPerView:3},1024:{slidesPerView:4},1440:{slidesPerView:5}}})}if($(".skills-progress-bar").length){$(".skills-progress-bar").waypoint(function(){$(".skillbar").each(function(){$(this).find(".count-bar").animate({width:$(this).attr("data-percent")},2e3)})},{offset:"70%"})}if($("#herovideo").length&&$.fn.YTPlayer){var myPlayer=$("#herovideo").YTPlayer()}var heroVideo=document.querySelector("[data-hero-video]");if(heroVideo){var heroVideoMobileQuery=window.matchMedia("(max-width: 767px)");var heroVideoSource=heroVideo.querySelector("source");var heroVideoWrapper=heroVideo.closest(".hero-bg-video");var heroVideoSection=heroVideo.closest(".hero-video");var heroVideoCurrentMode="";function setHeroVideoPosterBackground(posterUrl){if(heroVideoWrapper&&posterUrl){heroVideoWrapper.style.backgroundImage='url("'+posterUrl+'")'}}function showHeroVideoPoster(){if(heroVideoSection){heroVideoSection.classList.add("hero-video-poster-mode")}heroVideo.pause()}function showHeroVideoPlayback(){if(heroVideoSection){heroVideoSection.classList.remove("hero-video-poster-mode")}}function setResponsiveHeroVideo(){var isMobileHeroVideo=heroVideoMobileQuery.matches;var nextHeroVideoMode=isMobileHeroVideo?"mobile":"desktop";var nextHeroVideoSrc=isMobileHeroVideo?heroVideo.dataset.mobileSrc:heroVideo.dataset.desktopSrc;var nextHeroVideoPoster=isMobileHeroVideo?heroVideo.dataset.mobilePoster:heroVideo.dataset.desktopPoster;setHeroVideoPosterBackground(nextHeroVideoPoster);if(!nextHeroVideoSrc||heroVideoCurrentMode===nextHeroVideoMode){return}if(!heroVideoSource){heroVideoSource=document.createElement("source");heroVideoSource.type="video/mp4";heroVideo.appendChild(heroVideoSource)}if(nextHeroVideoPoster){heroVideo.setAttribute("poster",nextHeroVideoPoster)}heroVideoCurrentMode=nextHeroVideoMode;heroVideo.muted=true;heroVideo.defaultMuted=true;heroVideo.playsInline=true;heroVideo.setAttribute("muted","");heroVideo.setAttribute("playsinline","");heroVideo.removeAttribute("controls");showHeroVideoPlayback();if(heroVideoSource.getAttribute("src")!==nextHeroVideoSrc){heroVideoSource.setAttribute("src",nextHeroVideoSrc);heroVideo.load()}try{var heroVideoPlay=heroVideo.play();if(heroVideoPlay&&heroVideoPlay.then){heroVideoPlay.then(showHeroVideoPlayback).catch(showHeroVideoPoster)}}catch(error){showHeroVideoPoster()}}setResponsiveHeroVideo();if(heroVideoMobileQuery.addEventListener){heroVideoMobileQuery.addEventListener("change",setResponsiveHeroVideo)}else if(heroVideoMobileQuery.addListener){heroVideoMobileQuery.addListener(setResponsiveHeroVideo)}}var lazyVideos=document.querySelectorAll("video[data-lazy-video]");if(lazyVideos.length){function loadLazyVideo(video){if(!video||video.dataset.loaded==="true"){return}var lazyVideoSrc=video.dataset.src;if(!lazyVideoSrc){return}var lazyVideoSource=document.createElement("source");lazyVideoSource.src=lazyVideoSrc;lazyVideoSource.type="video/mp4";video.appendChild(lazyVideoSource);video.dataset.loaded="true";video.load();try{var lazyVideoPlay=video.play();if(lazyVideoPlay&&lazyVideoPlay.catch){lazyVideoPlay.catch(function(){})}}catch(error){}}if("IntersectionObserver"in window){var lazyVideoObserver=new IntersectionObserver(function(entries,observer){entries.forEach(function(entry){if(entry.isIntersecting){loadLazyVideo(entry.target);observer.unobserve(entry.target)}})},{rootMargin:"1000px 0px"});lazyVideos.forEach(function(video){lazyVideoObserver.observe(video)})}else{$window.on("load",function(){lazyVideos.forEach(loadLazyVideo)})}}if($(".counter").length){$(".counter").counterUp({delay:6,time:3e3})}if($(".reveal").length){gsap.registerPlugin(ScrollTrigger);let revealContainers=document.querySelectorAll(".reveal");revealContainers.forEach(container=>{let image=container.querySelector("img");let tl=gsap.timeline({scrollTrigger:{trigger:container,toggleActions:"play none none none"}});tl.set(container,{autoAlpha:1});tl.from(container,1,{xPercent:-100,ease:Power2.out});tl.from(image,1,{xPercent:100,scale:1,delay:-1,ease:Power2.out})})}function initHeadingAnimation(){if($(".text-effect").length){var textheading=$(".text-effect");if(textheading.length===0)return;gsap.registerPlugin(SplitText);textheading.each(function(index,el){el.split=new SplitText(el,{type:"lines,words,chars",linesClass:"split-line"});if($(el).hasClass("text-effect")){gsap.set(el.split.chars,{opacity:.3,x:"-7"})}el.anim=gsap.to(el.split.chars,{scrollTrigger:{trigger:el,start:"top 92%",end:"top 60%",markers:false,scrub:1},x:"0",y:"0",opacity:1,duration:.7,stagger:.2})})}if($(".text-anime-style-1").length){let staggerAmount=.05,translateXValue=0,delayValue=.5,animatedTextElements=document.querySelectorAll(".text-anime-style-1");animatedTextElements.forEach(element=>{let animationSplitText=new SplitText(element,{type:"chars, words"});gsap.from(animationSplitText.words,{duration:1,delay:delayValue,x:20,autoAlpha:0,stagger:staggerAmount,scrollTrigger:{trigger:element,start:"top 85%"}})})}if($(".text-anime-style-2").length){let staggerAmount=.03,translateXValue=20,delayValue=.1,easeType="power2.out",animatedTextElements=document.querySelectorAll(".text-anime-style-2");animatedTextElements.forEach(element=>{let animationSplitText=new SplitText(element,{type:"chars, words"});gsap.from(animationSplitText.chars,{duration:1,delay:delayValue,x:translateXValue,autoAlpha:0,stagger:staggerAmount,ease:easeType,scrollTrigger:{trigger:element,start:"top 85%"}})})}if($(".text-anime-style-3").length){let animatedTextElements=document.querySelectorAll(".text-anime-style-3");animatedTextElements.forEach(element=>{if(element.animation){element.animation.progress(1).kill();element.split.revert()}element.split=new SplitText(element,{type:"lines,words,chars",linesClass:"split-line"});gsap.set(element,{perspective:400});gsap.set(element.split.chars,{opacity:0,x:"50"});element.animation=gsap.to(element.split.chars,{scrollTrigger:{trigger:element,start:"top 90%"},x:"0",y:"0",rotateX:"0",opacity:1,duration:1,ease:Back.easeOut,stagger:.02})})}}if(document.fonts&&document.fonts.ready){document.fonts.ready.then(()=>{initHeadingAnimation()})}else{window.addEventListener("load",initHeadingAnimation)}var $parallaxie=$(".parallaxie");if($parallaxie.length&&$window.width()>1024){if($window.width()>768){$parallaxie.parallaxie({speed:.55,offset:0})}}if($.fn.magnificPopup&&$(".gallery-items").length){$(".gallery-items").magnificPopup({delegate:"a",type:"image",closeOnContentClick:false,closeBtnInside:false,mainClass:"mfp-with-zoom",image:{verticalFit:true},gallery:{enabled:true},zoom:{enabled:true,duration:300,opener:function(element){return element.find("img")}}})}var $contactform=$("#contactForm");$contactform.validator({focus:false}).on("submit",function(event){if(!event.isDefaultPrevented()){event.preventDefault();submitForm()}});function submitForm(){$.ajax({type:"POST",url:"form-process.php",data:$contactform.serialize(),success:function(text){if(text==="success"){formSuccess()}else{submitMSG(false,text)}}})}function formSuccess(){$contactform[0].reset();submitMSG(true,"Message Sent Successfully!")}function submitMSG(valid,msg){if(valid){var msgClasses="h4 text-success"}else{var msgClasses="h4 text-danger"}$("#msgSubmit").removeClass().addClass(msgClasses).text(msg)}(new WOW).init();if($(".popup-video").length&&$.fn.magnificPopup){$(".popup-video").magnificPopup({type:"iframe",mainClass:"mfp-fade",removalDelay:160,preloader:false,fixedContentPos:true})}var $service_item_list=$(".service-item-list");if($service_item_list.length){var $service_item=$service_item_list.find(".service-item");if($service_item.length){$service_item.on({mouseenter:function(){if(!$(this).hasClass("active")){$service_item.removeClass("active");$(this).addClass("active")}},mouseleave:function(){}})}}var $service_item_list_prime=$(".service-item-list-prime");if($service_item_list_prime.length){var $service_item_prime=$service_item_list_prime.find(".service-item-prime");if($service_item_prime.length){$service_item_prime.on({mouseenter:function(){if(!$(this).hasClass("active")){$service_item_prime.removeClass("active");$(this).addClass("active")}},mouseleave:function(){}})}}})(jQuery);